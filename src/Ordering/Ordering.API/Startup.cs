...
namespace Ordering.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IOrderPepository, OrderRepository>();
            services.AddScoped(typeof(IRepository<>), typeof(Repository<>));
            //services.AddScoped(typeof(IOrderPepository), typeof(OrderRepository));
            ...
            services.AddSingleton<IRabbitMqConnection>(sr =>
            {
